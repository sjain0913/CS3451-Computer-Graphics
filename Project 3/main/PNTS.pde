...
class PNTS 
 ...
 // CREATE
  ...
  void translate(int s, int e) // moves all points to mimick mouse motion
    { 
    if(e<pointCount) for (int i=s; i<=e; i++) G[i].moveWithMouse(); 
    }      
